...
<script type="text/javascript"> //<!-- FONCTION NAVIGATION SPA - PRIVATE FN       -->
  ...
  function scrollToSection(nwSecID) {                                             // Logique spécifique pour la navigation par ancre
    ...
    <script type="text/javascript"> //<!-- FONCTION D'INITIALISATION GLOBALE          --> OK
      /**-----------------------------------------------------------------------------//
       * @instanceIn      {loadPage}                        ../
       * @instanceCount   1 - unique
       * ---------------- --------------- --------------- - --------------------------//
    ...
    <script type="text/javascript"> //<!-- GUIDEMODE                      (COMPOSANT) -->
      /**-----------------------------------------------------------------------------//
       * @version         25.10.09 (23:16)
       * @instanceIn      {handlePageData}
       * @instanceCount   1 - unique
    ...
    <script type="text/javascript"> //<!-- APP HELPER - UPDATESTATUS     (UTILITAIRE) -->
      /**-----------------------------------------------------------------------------//
    ...
    <script type="text/javascript"> //<!-- FONCTION HELPERS - PRIVATE    (UTILITAIRE) -->
      /**-----------------------------------------------------------------------------//
    ...
    <script type="text/javascript"> //<!-- APP LAUNCHER                          (🚀) -->
      console.log (` \n\n🚀=============================================🚀 ${DATE} 🚀=============================================🚀\n\n🏁 C'est parti.` );
